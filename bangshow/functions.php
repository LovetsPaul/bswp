<?php
/**
 * bangshow functions and definitions
 *
...
if ( ! function_exists( 'bangshow_setup' ) ) :
/**
 ...
 */
function bangshow_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on bangshow, use a find and replace
	 * to change 'bangshow' to the name of your theme in all the template files.
	 */
	...
	add_theme_support( 'custom-background', apply_filters( 'bangshow_custom_background_args', array(
...
add_action( 'after_setup_theme', 'bangshow_setup' );
 ...
 */
function bangshow_content_width() {
...
add_action( 'wp_enqueue_scripts', 'bangshow_scripts' );
