...
function bangshow_register_my_cpts_bang_girl() {
	...
	$args = array(
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => array( "slug" => "bang-girl", "with_front" => true ),
		"query_var" => true,
		"supports" => array( "title", "editor", "thumbnail" ),
	);

	register_post_type( "bang-girl", $args );
}

add_action( 'init', 'bangshow_register_my_cpts_bang_girl' );